...
export const WORKOUT_SPLIT: WorkoutRoutine[] = [
  ...
  {
    id: 'push',
    name: 'Push (Chest + Delts)',
    focus: 'Push Power',
    exercises: [EXERCISES.benchPress, EXERCISES.ohp, EXERCISES.inclineDbPress, EXERCISES.lateralRaise, EXERCISES.tricepPushdown],
  },
  // Day 2
  {
    id: 'pull',
    ...
    focus: 'Pull Power',
    exercises: [EXERCISES.pullUp, EXERCISES.barbellRow, EXERCISES.facePull, EXERCISES.bicepCurl, EXERCISES.hammerCurl],
  },
  // Day 3
  {
    id: 'legs',
    name: 'Legs + Abs',
    focus: 'Leg Power',
    exercises: [EXERCISES.squat, EXERCISES.rdl, EXERCISES.legExt, EXERCISES.calfRaise, EXERCISES.hangingLegRaise],
  },
  // Day 4
  {
    id: 'shoulders_arms',
    name: 'Shoulders + Arms',
    focus: 'Aesthetic Focus',
    exercises: [EXERCISES.arnoldPress, EXERCISES.cableLateral, EXERCISES.skullCrusher, EXERCISES.preacherCurl, EXERCISES.lateralRaise],
  },
  // Day 5
  {
    id: 'upper_chest_back',
    ...
    focus: 'V-Taper',
    exercises: [EXERCISES.inclineBarbell, EXERCISES.latPulldown, EXERCISES.chestFly, EXERCISES.pullover, EXERCISES.facePull],
  },
  // Day 6
  {
    id: 'conditioning',
    ...
    focus: 'Fat Loss',
    exercises: [EXERCISES.hiit, EXERCISES.hangingLegRaise, EXERCISES.crunch, EXERCISES.plank],
  },
  // Day 7
  {
    id: 'rest',
